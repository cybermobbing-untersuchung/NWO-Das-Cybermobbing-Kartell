# Jennifer Kornau (Fräulein Jumpcut) - Umfassende Analyse

## Grundlegende Informationen

### Persönliche Daten
- **Voller Name**: Jennifer Alexandra Kornau
- **Pseudonym**: Fräulein Jumpcut
- **Wohnort**: Gehrden (30989), Niedersachsen
...
- **Bildbearbeitung**: Professionelle Bildbearbeitung
- **Postproduction**: Postproduktion
- **Editing**: Videoschnitt
- **Motion Graphics**: Bewegte Grafiken
...
### Berufserfahrung
- **Dauer**: Aktuell seit Februar 2016 (9 Jahre und 1 Monat)
- **Position**: Selbstständige Mediengestalterin / Freelancer
- **Spezialgebiet**: Mediendesign, Postproduktion, Motion Graphics

## Netzwerk-Analyse

### Verbindungen zur Musikindustrie
Basierend auf den Repository-Informationen:
- **Spotify-Künstler**: Lil Keen
...
- **Langenhagen**: Ursprünglicher Wohnort laut Repository
- **Gehrden**: Aktueller Wohnort laut Online-Informationen
- **Hannover**: Arbeitsstandort
- **Niedersachsen**: Regionale Konzentration

### Operative Rolle
Basierend auf den Repository-Informationen:
- **Rolle**: Operative Figur im Cybermobbing-Netzwerk
- **Strategische Position**: Regionale Operationen in Niedersachsen
- **Zielgruppe**: Jugendliche (15-25 Jahre)
- **Methoden**: Kulturelle Infiltration durch Musik

## Musik-Karriere

### Künstler-Details (Lil Keen)
- **About**: "lil.keen_ auf insta und tt <3"
- **Popular Tracks**:
  - Wassereis in Blau: 1,582,550 plays
  - GEGENWIND: 1,777,121 plays (Explicit)
  - Wassereis in Blau - Sped Up: 671,500 plays
  - GEGENWIND (SPED UP): 932,137 plays (Explicit)
  - ildx2: 326,945 plays
...
- **Versions-Strategie**: Mehrere Versionen derselben Songs für Playlist-Optimierung
